...
global.ownername = process.env.Owner_Name || "Senesh Shashmika" 
global.ownernumber = process.env.Owner_Number || "94713106474" 
...
global.mongoUrl = process.env.MongoDB || "mongodb+srv://seneshshashmika18:@Senuwa18@cluster0.9whtcb3.mongodb.net/"; 
...
module.exports = {
  ...
  ownername: process.env.Owner_Name || "Senesh Shashmika",
  ownernumber: process.env.Owner_Number || "9471306474",
  adress: process.env.Continent || "Asia, SriLanka ,Matara",
  timezone: process.env.TimeZone || "Asia/Colombo", 
  instagramId: process.env.Insta || "8.08_only_mine",
  email: process.env.Email_Id || "example@example.com",
  warns: process.env.Warns_Limits || 3,
  mongoUrl: process.env.MongoDB || "mongodb+srv://seneshshashmika18:@Senuwa18@cluster0.9whtcb3.mongodb.net/",
